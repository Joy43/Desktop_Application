...
const SignInPage = ({ onSwitchToSignUp, onSwitchToForgot }) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
              ...
              <div>
                ...
                <input
                  type="email"
                  placeholder="Email"
                  className="mt-2 w-full bg-[#EDEFF0] py-3 px-4 border-none outline-none"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="mt-2 w-full bg-[#EDEFF0] py-3 px-4 pr-10 outline-none"
                    {...register('password', {
              ...
              <button
                type="submit"
                className="bg-brick-red text-white py-2 px-6 border border-[#62180F] rounded-none hover:bg-[#7c2d22] text-sm"
              >
